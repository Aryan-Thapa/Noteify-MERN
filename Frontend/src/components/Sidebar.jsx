...
import { ChevronLeftIcon, ChevronRightIcon, FunnelIcon, MoonIcon, SunIcon, EllipsisVerticalIcon } from "@heroicons/react/24/outline";
...
const Sidebar = ({
  ...
  return (
    <div className={`flex flex-col transition-all duration-200 border-r border-gray-200 dark:border-white/20 ${sidebarOpen ? "w-64" : "w-12"} ${darkMode ? "bg-white/10" : "bg-white"} backdrop-blur-md`}>
